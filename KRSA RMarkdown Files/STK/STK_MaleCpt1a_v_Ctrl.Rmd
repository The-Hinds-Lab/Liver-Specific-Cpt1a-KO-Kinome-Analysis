---
title: "![](/Users/Evelyn/Library/CloudStorage/OneDrive-UniversityofKentucky/Uni of Kentucky/Kinome_PamGene/Custom_Report_Hinds/images/Pathways Lab logo.png){width=5in}"
<br>
<br>
author: 
...
experiment_ID <- "Nate_STKFullReport_MaleCpt1a"

#comparison variables

name_in_input_groupA <- "Male LKO"
shorthand_groupA <- "exp"
name_in_input_groupB <- "Male Control"
...
kinases_of_interest <-c("PRKX", "PKG2", "PKA[alpha]", "p70S6K[beta]", "CK1[delta]", "PKG1", "IKK[alpha]", "Akt1/PKB[alpha]", "CaMK4", "CK1[epsilon]", "PKD1", "COT", "Akt2/PKB[beta]", "CK1[alpha]", "CaMK2[alpha]", "SGK2")
...
### Male Cpt1aKO vs Male WT (Heatmap)
...
source("~/Library/CloudStorage/OneDrive-UniversityofKentucky/Uni of Kentucky/Kinome_PamGene/KRSA-master/R/krsa_heatmap STK.R")
...
### Male Cpt1aKO vs Male WT (Violin Plot)
...
### Male Cpt1aKO vs Male WT (Waterfall Plot)
...
### Male Cpt1aKO vs Male WT (Curve Plot)
...
### Male Cpt1aKO vs Male WT (Upstream Kinase Analysis (UKA) - Kinase Families)
...
png(file = (paste0(EAB_directory_output_comparison_families, "Fig1-P38","-",experiment_ID,".png")),width = 11250,height = 10000,units = "px",pointsize = 12,res = 7000)
krsa_histogram_plot(fin$KRSA_Table, fin$count_mtx, "P38")
dev.off()

png(file = (paste0(EAB_directory_output_comparison_families, "Fig2-JNK","-",experiment_ID,".png")),width = 11250,height = 10000,units = "px",pointsize = 12,res = 7000)
krsa_histogram_plot(fin$KRSA_Table, fin$count_mtx, "JNK")
dev.off()

png(file = (paste0(EAB_directory_output_comparison_families, "Fig3-PKA","-",experiment_ID,".png")),width = 11250,height = 10000,units = "px",pointsize = 12,res = 7000)
krsa_histogram_plot(fin$KRSA_Table, fin$count_mtx, "PKA")
dev.off()
...
png(file = (paste0(EAB_directory_output_comparison_families, "Fig5-PKG","-",experiment_ID,".png")),width = 11250,height = 10000,units = "px",pointsize = 12,res = 7000)
krsa_histogram_plot(fin$KRSA_Table, fin$count_mtx, "PKG")
dev.off()

png(file = (paste0(EAB_directory_output_comparison_families, "Fig6-RSK","-",experiment_ID,".png")),width = 11250,height = 10000,units = "px",pointsize = 12,res = 7000)
...
### Male Cpt1aKO vs Male WT (Reverse KRSA Plot)
...
### Male Cpt1aKO vs Male WT (Coverage Plot)
...
### Male Cpt1aKO vs Male WT (Ball Model Network)
...
### Male Cpt1aKO vs Male WT (Upstream Kinase Analysis (UKA) - Individual Kinases)
...
### Male Cpt1aKO vs Male WT - **Bionavigator** Upstream Kinase Analysis (UKA)
...
```{r, echo=F,fig.align='center', fig.height=10, fig.width=8, message=FALSE, cache=TRUE}

knitr::include_graphics("/Users/Evelyn/Dropbox/PamGene Projects and Runs - Hinds Lab files/Nate Cpt1a Hepatic KO PTK and STK data_7-19-22/STK/UKA Images and Summary/Male LKO vs Male Control/UpstreamScorePlot 20220810-1025.png")
...
#this sources the code that pulls the uniprot protein name for each corresponding peptide substrate. This was 
#a special request from Nate for just PKA[alpha]
...
mapped_with_pepName %>% 
  # choose kinase to plot
  filter(Kin %in% kinases_of_interest[3]) %>% 
  krsa_waterfall(0.2) +
  facet_wrap(~Kin, scales = "free_y")
...
### Male Cpt1aKO vs Male WT (Upstream Kinase Analysis - Individual Kinases)
...
### Male Cpt1aKO vs Male WT (Z Scores Plot)
...
### Male Cpt1aKO vs Male WT individual kinases - Generate peacock plots
...
krsa_histogram_plot(fin$KRSA_Table, fin$count_mtx, c("PRKX", "PKG2", "PKA[alpha]", "p70S6K[beta]", "CK1[delta]", "PKG1", "IKK[alpha]", "Akt1/PKB[alpha]", "CaMK4", "CK1[epsilon]", "PKD1", "COT", "Akt2/PKB[beta]", "CK1[alpha]", "CaMK2[alpha]", "SGK2"))

png(file = (paste0(EAB_directory_output_comparison, "Fig1-PRKX","-",experiment_ID,".png")),width = 11250,height = 10000,units = "px",pointsize = 12,res = 7000)
krsa_histogram_plot(fin$KRSA_Table, fin$count_mtx, "PRKX")
dev.off()

png(file = (paste0(EAB_directory_output_comparison, "Fig2-PKG2","-",experiment_ID,".png")),width = 11250,height = 10000,units = "px",pointsize = 12,res = 7000)
krsa_histogram_plot(fin$KRSA_Table, fin$count_mtx, "PKG2")
dev.off()

png(file = (paste0(EAB_directory_output_comparison, "Fig3-PKA[alpha]","-",experiment_ID,".png")),width = 11250,height = 10000,units = "px",pointsize = 12,res = 7000)
krsa_histogram_plot(fin$KRSA_Table, fin$count_mtx, "PKA[alpha]")
dev.off()

png(file = (paste0(EAB_directory_output_comparison, "Fig4-p70S6K[beta]","-",experiment_ID,".png")),width = 11250,height = 10000,units = "px",pointsize = 12,res = 7000)
krsa_histogram_plot(fin$KRSA_Table, fin$count_mtx, "p70S6K[beta]")
dev.off()

png(file = (paste0(EAB_directory_output_comparison, "Fig5-CK1[delta]","-",experiment_ID,".png")),width = 11250,height = 10000,units = "px",pointsize = 12,res = 7000)
krsa_histogram_plot(fin$KRSA_Table, fin$count_mtx, "CK1[delta]")
dev.off()

png(file = (paste0(EAB_directory_output_comparison, "Fig6-PKG1","-",experiment_ID,".png")),width = 11250,height = 10000,units = "px",pointsize = 12,res = 7000)
krsa_histogram_plot(fin$KRSA_Table, fin$count_mtx, "PKG1")
dev.off()

png(file = (paste0(EAB_directory_output_comparison, "Fig7-IKK[alpha]","-",experiment_ID,".png")),width = 11250,height = 10000,units = "px",pointsize = 12,res = 7000)
krsa_histogram_plot(fin$KRSA_Table, fin$count_mtx, "IKK[alpha]")
dev.off()

png(file = (paste0(EAB_directory_output_comparison, "Fig8-Akt1-PKB[alpha]","-",experiment_ID,".png")),width = 11250,height = 10000,units = "px",pointsize = 12,res = 7000)
krsa_histogram_plot(fin$KRSA_Table, fin$count_mtx, "Akt1/PKB[alpha]")
dev.off()

png(file = (paste0(EAB_directory_output_comparison, "Fig9-CaMK4","-",experiment_ID,".png")),width = 11250,height = 10000,units = "px",pointsize = 12,res = 7000)
krsa_histogram_plot(fin$KRSA_Table, fin$count_mtx, "CaMK4")
dev.off()

png(file = (paste0(EAB_directory_output_comparison, "Fig10-CK1[epsilon]","-",experiment_ID,".png")),width = 11250,height = 10000,units = "px",pointsize = 12,res = 7000)
krsa_histogram_plot(fin$KRSA_Table, fin$count_mtx, "CK1[epsilon]")
dev.off()

png(file = (paste0(EAB_directory_output_comparison, "Fig11-PKD1","-",experiment_ID,".png")),width = 11250,height = 10000,units = "px",pointsize = 12,res = 7000)
krsa_histogram_plot(fin$KRSA_Table, fin$count_mtx, "PKD1")
dev.off()

png(file = (paste0(EAB_directory_output_comparison, "Fig12-COT","-",experiment_ID,".png")),width = 11250,height = 10000,units = "px",pointsize = 12,res = 7000)
krsa_histogram_plot(fin$KRSA_Table, fin$count_mtx, "COT")
dev.off()

png(file = (paste0(EAB_directory_output_comparison, "Fig13-Akt2-PKB[beta]","-",experiment_ID,".png")),width = 11250,height = 10000,units = "px",pointsize = 12,res = 7000)
krsa_histogram_plot(fin$KRSA_Table, fin$count_mtx, "Akt2/PKB[beta]")
dev.off()

png(file = (paste0(EAB_directory_output_comparison, "Fig14-CK1[alpha]","-",experiment_ID,".png")),width = 11250,height = 10000,units = "px",pointsize = 12,res = 7000)
krsa_histogram_plot(fin$KRSA_Table, fin$count_mtx, "CK1[alpha]")
dev.off()

png(file = (paste0(EAB_directory_output_comparison, "Fig15-CaMK2[alpha]","-",experiment_ID,".png")),width = 11250,height = 10000,units = "px",pointsize = 12,res = 7000)
