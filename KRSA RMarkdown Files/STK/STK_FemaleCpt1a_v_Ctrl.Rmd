---
title: "![](~/Library/CloudStorage/OneDrive-UniversityofKentucky/Uni of Kentucky/Kinome_PamGene/KRSA-master/images/Pathways Lab logo.png){width=5in}"
author: 
-   "**The Hinds Laboratory Pathways Lab Report**"
-   <br>
-   "**STK Analysis Report**"
-   <br>
...
input_directory_MedianSigmBg <- "~/Library/CloudStorage/OneDrive-UniversityofKentucky/Uni of Kentucky/Kinome_PamGene/Nate/STK/input_data/_Export_Median_SigmBg_220719163019.txt"

input_directory_Signal_Saturation <- "~/Library/CloudStorage/OneDrive-UniversityofKentucky/Uni of Kentucky/Kinome_PamGene/Nate/STK/input_data/_Export_Signal_Saturation_220719163019.txt"

#experiment_ID

experiment_ID <- "Nate_STKFullReport_FemaleCpt1a"

#comparison variables

name_in_input_groupA <- "Female LKO"
shorthand_groupA <- "exp"
name_in_input_groupB <- "Female Control"
...
kinases_of_interest <-c("PKA[alpha]", "PKN1/PRK1", "Akt2/PKB[beta]", "Akt1/PKB[alpha]", "RSK2", "RSK1/p90RSK", "CaMK2[alpha]", "PKC[theta}", "AMPK[alpha]1", "PKC[alpha]", "PRKX", "GSK3[beta]", "GSK3[alpha]", "PKG1", "MSK2", "MSK1", "COT", "DAPK1", "RSK3", "PKG2", "CK2[alpha]1", "PFTAIRE1", "SGK2", "IKK[beta]")
...
knitr::include_graphics("~/Library/CloudStorage/OneDrive-UniversityofKentucky/Uni of Kentucky/Kinome_PamGene/KRSA-master/images/pamgene_workflow.png")
knitr::include_graphics("~/Library/CloudStorage/OneDrive-UniversityofKentucky/Uni of Kentucky/Kinome_PamGene/KRSA-master/images/pamgene_detectionFig.png")
```
\newpage
...
The slope transformed values are used for global signal intensity determination across samples and groups. We will create CV and violin plots, and create heatmaps to visualize our fitted data. We then filter out peptides with poor linear fit and references peptides.
...
The global heatmap represents all peptides present on the chip, with the postive/internal controls removed. The peptides that failed to pass quality control are also removed. The heatmap shown below is scaled by row to highlight the similar/different peptide signals across the samples. Unsupervised hierarchial clustering is used on both peptides and samples to highlight potentially similar peptide signal signatures. 
...
### Female Cpt1aKO vs Female WT (Heatmap)
...
source("/Users/Evelyn/Library/CloudStorage/OneDrive-UniversityofKentucky/Uni of Kentucky/Kinome_PamGene/Custom_Report_Hinds/KRSA-master/R/krsa_heatmap STK.R")
...
### Female Cpt1aKO vs Female WT (Violin Plot)
...
### Female Cpt1aKO vs Female WT (Waterfall Plot)
...
source("~/Library/CloudStorage/OneDrive-UniversityofKentucky/Uni of Kentucky/Kinome_PamGene/KRSA-master/R/krsa_waterfall.R")
...
### Female Cpt1aKO vs Female WT (Curve Plot)
...
### Female Cpt1aKO vs Female WT (Upstream Kinase Analysis (UKA) - Kinase Families)
...
if(chipType == "STK"){chipCov <- KRSA_coverage_STK_PamChip_87102_v2}
...
krsa_top_hits(AvgZTable2, 1.5) -> kinases_hits
...
```{r save Peacock Plots- Kinase families, echo=F, warning=F, message=FALSE}

#This will change per run and creates the peacock plots for the kinase families

png(file = (paste0(EAB_directory_output_comparison_families, "Fig1-JNK","-",experiment_ID,".png")),width = 11250,height = 10000,units = "px",pointsize = 12,res = 7000)
krsa_histogram_plot(fin$KRSA_Table, fin$count_mtx, "JNK")
dev.off()

png(file = (paste0(EAB_directory_output_comparison_families, "Fig2-P38","-",experiment_ID,".png")),width = 11250,height = 10000,units = "px",pointsize = 12,res = 7000)
krsa_histogram_plot(fin$KRSA_Table, fin$count_mtx, "P38")
dev.off()

png(file = (paste0(EAB_directory_output_comparison_families, "Fig3-NMO","-",experiment_ID,".png")),width = 11250,height = 10000,units = "px",pointsize = 12,res = 7000)
krsa_histogram_plot(fin$KRSA_Table, fin$count_mtx, "NMO")
dev.off()

png(file = (paste0(EAB_directory_output_comparison_families, "Fig4-ERK","-",experiment_ID,".png")),width = 11250,height = 10000,units = "px",pointsize = 12,res = 7000)
krsa_histogram_plot(fin$KRSA_Table, fin$count_mtx, "ERK")
dev.off()

png(file = (paste0(EAB_directory_output_comparison_families, "Fig5-CDK","-",experiment_ID,".png")),width = 11250,height = 10000,units = "px",pointsize = 12,res = 7000)
krsa_histogram_plot(fin$KRSA_Table, fin$count_mtx, "CDK")
dev.off()

png(file = (paste0(EAB_directory_output_comparison_families, "Fig6-PDK1","-",experiment_ID,".png")),width = 11250,height = 10000,units = "px",pointsize = 12,res = 7000)
krsa_histogram_plot(fin$KRSA_Table, fin$count_mtx, "PDK1")
dev.off()

png(file = (paste0(EAB_directory_output_comparison_families, "Fig7-MAPKAPK","-",experiment_ID,".png")),width = 11250,height = 10000,units = "px",pointsize = 12,res = 7000)
krsa_histogram_plot(fin$KRSA_Table, fin$count_mtx, "MAPKAPK")
dev.off()

png(file = (paste0(EAB_directory_output_comparison_families, "Fig8-PKD","-",experiment_ID,".png")),width = 11250,height = 10000,units = "px",pointsize = 12,res = 7000)
krsa_histogram_plot(fin$KRSA_Table, fin$count_mtx, "PKD")
dev.off()

png(file = (paste0(EAB_directory_output_comparison_families, "Fig9-PKCD","-",experiment_ID,".png")),width = 11250,height = 10000,units = "px",pointsize = 12,res = 7000)
krsa_histogram_plot(fin$KRSA_Table, fin$count_mtx, "PKCD")
dev.off()

png(file = (paste0(EAB_directory_output_comparison_families, "Fig10-PAKB","-",experiment_ID,".png")),width = 11250,height = 10000,units = "px",pointsize = 12,res = 7000)
krsa_histogram_plot(fin$KRSA_Table, fin$count_mtx, "PAKB")
dev.off()

png(file = (paste0(EAB_directory_output_comparison_families, "Fig11-MELK","-",experiment_ID,".png")),width = 11250,height = 10000,units = "px",pointsize = 12,res = 7000)
krsa_histogram_plot(fin$KRSA_Table, fin$count_mtx, "MELK")
dev.off()

png(file = (paste0(EAB_directory_output_comparison_families, "Fig12-RSK","-",experiment_ID,".png")),width = 11250,height = 10000,units = "px",pointsize = 12,res = 7000)
krsa_histogram_plot(fin$KRSA_Table, fin$count_mtx, "RSK")
dev.off()

png(file = (paste0(EAB_directory_output_comparison_families, "Fig13-AMPK","-",experiment_ID,".png")),width = 11250,height = 10000,units = "px",pointsize = 12,res = 7000)
krsa_histogram_plot(fin$KRSA_Table, fin$count_mtx, "AMPK")
dev.off()
```

\newpage

### Female Cpt1aKO vs Female WT (Reverse KRSA Plot)
...
### Female Cpt1aKO vs Female WT (Coverage Plot)
...
### Female Cpt1aKO vs Female WT (Ball Model Network)
...
### Female Cpt1aKO vs Female WT (Upstream Kinase Analysis (UKA) - Individual Kinases)
...
Pamgene’s proprietary software, Bionavigator, provides a waterfall plot that scores individual kinases by a normalized kinase statistic and specificity score. The plot shown below helps us to select the kinases of interest for the rest of the individual kinase KRSA report. 

```{r, echo=F,fig.align='center', fig.height=9, fig.width=7, message=FALSE, cache=TRUE}

knitr::include_graphics("/Users/Evelyn/Dropbox/PamGene Projects and Runs - Hinds Lab files/Nate Cpt1a Hepatic KO PTK and STK data_7-19-22/STK/UKA Images and Summary/Female LKO vs Female Control/UpstreamScorePlot 20220810-1029.png")
...
uka_mp <- readRDS("~/Library/CloudStorage/OneDrive-UniversityofKentucky/Uni of Kentucky/Kinome_PamGene/KRSA-master/data-raw/uka_map_db.RDS")
...
source("~/Library/CloudStorage/OneDrive-UniversityofKentucky/Uni of Kentucky/Kinome_PamGene/KRSA-master/R/krsa_waterfall annotated.R")

mapped_lfc_table %>% 
  # choose kinase to plot
  filter(Kin %in% kinases_of_interest[1]) %>% 
  krsa_waterfall(0.2, byChip = T) +
...
### Female Cpt1aKO vs Female WT (Upstream Kinase Analysis - Individual Kinases)
...
### Female Cpt1aKO vs Female WT (Z Scores Plot)
...
### Female Cpt1aKO vs Female WT individual kinases - Generate peacock plots
...
krsa_histogram_plot(fin$KRSA_Table, fin$count_mtx, c("PKA[alpha]", "PKN1/PRK1", "Akt2/PKB[beta]", "Akt1/PKB[alpha]", "RSK2", "RSK1/p90RSK", "CaMK2", "PKC[theta}", "AMPK[alpha]1", "PKC[alpha]", "PRKX", "GSK3[beta]", "GSK3[alpha]", "PKG1", "MSK2", "MSK1", "COT", "DAPK1", "RSK3", "PKG2", "CK2[alpha]1", "PFTAIRE1", "SGK2", "IKK[beta]"))

png(file = (paste0(EAB_directory_output_comparison, "Fig1-PKA[alpha]","-",experiment_ID,".png")),width = 11250,height = 10000,units = "px",pointsize = 12,res = 7000)
krsa_histogram_plot(fin$KRSA_Table, fin$count_mtx, "PKA[alpha]")
dev.off()

png(file = (paste0(EAB_directory_output_comparison, "Fig2-PKN1-PRK1","-",experiment_ID,".png")),width = 11250,height = 10000,units = "px",pointsize = 12,res = 7000)
krsa_histogram_plot(fin$KRSA_Table, fin$count_mtx, "PKN1/PRK1")
dev.off()

png(file = (paste0(EAB_directory_output_comparison, "Fig3-Akt2-PKB[beta]","-",experiment_ID,".png")),width = 11250,height = 10000,units = "px",pointsize = 12,res = 7000)
krsa_histogram_plot(fin$KRSA_Table, fin$count_mtx, "Akt2/PKB[beta]")
dev.off()

png(file = (paste0(EAB_directory_output_comparison, "Fig4-Akt1-PKB[alpha]","-",experiment_ID,".png")),width = 11250,height = 10000,units = "px",pointsize = 12,res = 7000)
krsa_histogram_plot(fin$KRSA_Table, fin$count_mtx, "Akt1/PKB[alpha]")
dev.off()

png(file = (paste0(EAB_directory_output_comparison, "Fig5-RSK2","-",experiment_ID,".png")),width = 11250,height = 10000,units = "px",pointsize = 12,res = 7000)
krsa_histogram_plot(fin$KRSA_Table, fin$count_mtx, "RSK2")
dev.off()

png(file = (paste0(EAB_directory_output_comparison, "Fig6-RSK1-p90RSK","-",experiment_ID,".png")),width = 11250,height = 10000,units = "px",pointsize = 12,res = 7000)
krsa_histogram_plot(fin$KRSA_Table, fin$count_mtx, "RSK1/p90RSK")
dev.off()

png(file = (paste0(EAB_directory_output_comparison, "Fig7-CaMK2[alpha]","-",experiment_ID,".png")),width = 11250,height = 10000,units = "px",pointsize = 12,res = 7000)
krsa_histogram_plot(fin$KRSA_Table, fin$count_mtx, "CaMK2[alpha]")
dev.off()

png(file = (paste0(EAB_directory_output_comparison, "Fig8-PKC[theta]","-",experiment_ID,".png")),width = 11250,height = 10000,units = "px",pointsize = 12,res = 7000)
krsa_histogram_plot(fin$KRSA_Table, fin$count_mtx, "PKC[theta]")
dev.off()

png(file = (paste0(EAB_directory_output_comparison, "Fig9-AMPK[alpha]1","-",experiment_ID,".png")),width = 11250,height = 10000,units = "px",pointsize = 12,res = 7000)
krsa_histogram_plot(fin$KRSA_Table, fin$count_mtx, "AMPK[alpha]1")
dev.off()

png(file = (paste0(EAB_directory_output_comparison, "Fig10-PKC[alpha]","-",experiment_ID,".png")),width = 11250,height = 10000,units = "px",pointsize = 12,res = 7000)
krsa_histogram_plot(fin$KRSA_Table, fin$count_mtx, "PKC[alpha]")
dev.off()

png(file = (paste0(EAB_directory_output_comparison, "Fig11-PRKX","-",experiment_ID,".png")),width = 11250,height = 10000,units = "px",pointsize = 12,res = 7000)
krsa_histogram_plot(fin$KRSA_Table, fin$count_mtx, "PRKX")
dev.off()

png(file = (paste0(EAB_directory_output_comparison, "Fig12-GSK3[beta]","-",experiment_ID,".png")),width = 11250,height = 10000,units = "px",pointsize = 12,res = 7000)
krsa_histogram_plot(fin$KRSA_Table, fin$count_mtx, "GSK3[beta]")
dev.off()

png(file = (paste0(EAB_directory_output_comparison, "Fig13-GSK3[alpha]","-",experiment_ID,".png")),width = 11250,height = 10000,units = "px",pointsize = 12,res = 7000)
krsa_histogram_plot(fin$KRSA_Table, fin$count_mtx, "GSK3[alpha]")
dev.off()

png(file = (paste0(EAB_directory_output_comparison, "Fig14-CDC2-CDK1","-",experiment_ID,".png")),width = 11250,height = 10000,units = "px",pointsize = 12,res = 7000)
krsa_histogram_plot(fin$KRSA_Table, fin$count_mtx, "CDC2/CDK1")
dev.off()

png(file = (paste0(EAB_directory_output_comparison, "Fig15-PKG1","-",experiment_ID,".png")),width = 11250,height = 10000,units = "px",pointsize = 12,res = 7000)
krsa_histogram_plot(fin$KRSA_Table, fin$count_mtx, "PKG1")
dev.off()

png(file = (paste0(EAB_directory_output_comparison, "Fig16-MSK2","-",experiment_ID,".png")),width = 11250,height = 10000,units = "px",pointsize = 12,res = 7000)
krsa_histogram_plot(fin$KRSA_Table, fin$count_mtx, "MSK2")
dev.off()

png(file = (paste0(EAB_directory_output_comparison, "Fig17-MSK1","-",experiment_ID,".png")),width = 11250,height = 10000,units = "px",pointsize = 12,res = 7000)
krsa_histogram_plot(fin$KRSA_Table, fin$count_mtx, "MSK1")
dev.off()

png(file = (paste0(EAB_directory_output_comparison, "Fig18-COT","-",experiment_ID,".png")),width = 11250,height = 10000,units = "px",pointsize = 12,res = 7000)
krsa_histogram_plot(fin$KRSA_Table, fin$count_mtx, "COT")
dev.off()

png(file = (paste0(EAB_directory_output_comparison, "Fig19-DAPK1","-",experiment_ID,".png")),width = 11250,height = 10000,units = "px",pointsize = 12,res = 7000)
krsa_histogram_plot(fin$KRSA_Table, fin$count_mtx, "DAPK1")
dev.off()

png(file = (paste0(EAB_directory_output_comparison, "Fig20-RSK3","-",experiment_ID,".png")),width = 11250,height = 10000,units = "px",pointsize = 12,res = 7000)
krsa_histogram_plot(fin$KRSA_Table, fin$count_mtx, "RSK3")
dev.off()

png(file = (paste0(EAB_directory_output_comparison, "Fig21-PKG2","-",experiment_ID,".png")),width = 11250,height = 10000,units = "px",pointsize = 12,res = 7000)
krsa_histogram_plot(fin$KRSA_Table, fin$count_mtx, "PKG2")
dev.off()

png(file = (paste0(EAB_directory_output_comparison, "Fig22-CK2[alpha]1","-",experiment_ID,".png")),width = 11250,height = 10000,units = "px",pointsize = 12,res = 7000)
krsa_histogram_plot(fin$KRSA_Table, fin$count_mtx, "CK2[alpha]1")
dev.off()

png(file = (paste0(EAB_directory_output_comparison, "Fig23-PFTAIRE1","-",experiment_ID,".png")),width = 11250,height = 10000,units = "px",pointsize = 12,res = 7000)
krsa_histogram_plot(fin$KRSA_Table, fin$count_mtx, "PFTAIRE1")
dev.off()

png(file = (paste0(EAB_directory_output_comparison, "Fig24-SGK2","-",experiment_ID,".png")),width = 11250,height = 10000,units = "px",pointsize = 12,res = 7000)
krsa_histogram_plot(fin$KRSA_Table, fin$count_mtx, "SGK2")
dev.off()

png(file = (paste0(EAB_directory_output_comparison, "Fig25-IKK[beta]","-",experiment_ID,".png")),width = 11250,height = 10000,units = "px",pointsize = 12,res = 7000)
