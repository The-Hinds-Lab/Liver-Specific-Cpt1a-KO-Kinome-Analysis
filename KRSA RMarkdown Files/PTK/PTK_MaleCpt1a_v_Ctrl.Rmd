...
experiment_ID <- "Nate_FullReportPTK_MaleCpt1a"
...
kinases_of_interest <-c("JAK1~b", "JAK2", "BTK", "Srm", "Fes", "DDR1", "KDR", "BLK", "EphA2", "HER3", "FGFR3", "FGFR2", "Ret", "FRK", "FGFR4")
...
#save LFC files with mapped kinases (families) for meow plots

chipCov %>% rename(Peptide = Substrates) %>% left_join(diff_df, by = "Peptide")%>%
  remove_missing() -> mapped_kinase_LFC

mapped_kinase_LFC %>% write_csv(paste0(EAB_directory_output_comparison_per,Sys.Date(),"-","lfc_table_mapped_KinaseFamiliesMaleCpt1a_PTK.csv"))
...
png(file = (paste0(EAB_directory_output_comparison_families, "Fig1-CSK","-",experiment_ID,".png")),width = 11250,height = 10000,units = "px",pointsize = 12,res = 7000)
krsa_histogram_plot(fin$KRSA_Table, fin$count_mtx, "CSK")
dev.off()

png(file = (paste0(EAB_directory_output_comparison_families, "Fig2-DDR","-",experiment_ID,".png")),width = 11250,height = 10000,units = "px",pointsize = 12,res = 7000)
krsa_histogram_plot(fin$KRSA_Table, fin$count_mtx, "DDR")
dev.off()

png(file = (paste0(EAB_directory_output_comparison_families, "Fig3-FER","-",experiment_ID,".png")),width = 11250,height = 10000,units = "px",pointsize = 12,res = 7000)
krsa_histogram_plot(fin$KRSA_Table, fin$count_mtx, "FER")
dev.off()

png(file = (paste0(EAB_directory_output_comparison_families, "Fig4-FGFR","-",experiment_ID,".png")),width = 11250,height = 10000,units = "px",pointsize = 12,res = 7000)
krsa_histogram_plot(fin$KRSA_Table, fin$count_mtx, "FGFR")
dev.off()

png(file = (paste0(EAB_directory_output_comparison_families, "Fig5-FRK","-",experiment_ID,".png")),width = 11250,height = 10000,units = "px",pointsize = 12,res = 7000)
krsa_histogram_plot(fin$KRSA_Table, fin$count_mtx, "FRK")
dev.off()

png(file = (paste0(EAB_directory_output_comparison_families, "Fig6-MET","-",experiment_ID,".png")),width = 11250,height = 10000,units = "px",pointsize = 12,res = 7000)
krsa_histogram_plot(fin$KRSA_Table, fin$count_mtx, "MET")
dev.off()

png(file = (paste0(EAB_directory_output_comparison_families, "Fig7-RET","-",experiment_ID,".png")),width = 11250,height = 10000,units = "px",pointsize = 12,res = 7000)
krsa_histogram_plot(fin$KRSA_Table, fin$count_mtx, "RET")
dev.off()

png(file = (paste0(EAB_directory_output_comparison_families, "Fig8-SRC","-",experiment_ID,".png")),width = 11250,height = 10000,units = "px",pointsize = 12,res = 7000)
...
mapped_lfc_table %>% 
  # choose kinase to plot
  filter(Kin %in% kinases_of_interest[15]) %>% 
  krsa_waterfall(0.2) +
  facet_wrap(~Kin, scales = "free_y")
...
# processed_uka_map %>% rename(Peptide = ID) %>% left_join(diff_df, by = "Peptide")%>%
#   remove_missing() -> mapped_kinase_LFC
# 
# mapped_kinase_LFC %>% write_csv(paste0(EAB_directory_output_comparison_per,Sys.Date(),"-","lfc_table_mapped_KinaseIndividualMaleCpt1a_PTK.csv"))
...
krsa_histogram_plot(fin$KRSA_Table, fin$count_mtx, c("JAK1~b", "JAK2", "BTK", "Srm", "Fes", "DDR1", "KDR", "BLK", "EphA2", "HER3", "FGFR3", "FGFR2", "Ret", "FRK", "FGFR4"))

png(file = (paste0(EAB_directory_output_comparison, "Fig1-JAK1~b","-",experiment_ID,".png")),width = 11250,height = 10000,units = "px",pointsize = 12,res = 7000)
krsa_histogram_plot(fin$KRSA_Table, fin$count_mtx, "JAK1~b")
dev.off()

png(file = (paste0(EAB_directory_output_comparison, "Fig2-JAK2","-",experiment_ID,".png")),width = 11250,height = 10000,units = "px",pointsize = 12,res = 7000)
krsa_histogram_plot(fin$KRSA_Table, fin$count_mtx, "JAK2")
dev.off()

png(file = (paste0(EAB_directory_output_comparison, "Fig3-BTK","-",experiment_ID,".png")),width = 11250,height = 10000,units = "px",pointsize = 12,res = 7000)
krsa_histogram_plot(fin$KRSA_Table, fin$count_mtx, "BTK")
dev.off()

png(file = (paste0(EAB_directory_output_comparison, "Fig4-Srm","-",experiment_ID,".png")),width = 11250,height = 10000,units = "px",pointsize = 12,res = 7000)
krsa_histogram_plot(fin$KRSA_Table, fin$count_mtx, "Srm")
dev.off()

png(file = (paste0(EAB_directory_output_comparison, "Fig5-Fes","-",experiment_ID,".png")),width = 11250,height = 10000,units = "px",pointsize = 12,res = 7000)
krsa_histogram_plot(fin$KRSA_Table, fin$count_mtx, "Fes")
dev.off()

png(file = (paste0(EAB_directory_output_comparison, "Fig6-DDR1","-",experiment_ID,".png")),width = 11250,height = 10000,units = "px",pointsize = 12,res = 7000)
krsa_histogram_plot(fin$KRSA_Table, fin$count_mtx, "DDR1")
dev.off()

png(file = (paste0(EAB_directory_output_comparison, "Fig7-KDR","-",experiment_ID,".png")),width = 11250,height = 10000,units = "px",pointsize = 12,res = 7000)
krsa_histogram_plot(fin$KRSA_Table, fin$count_mtx, "KDR")
dev.off()

png(file = (paste0(EAB_directory_output_comparison, "Fig8-BLK","-",experiment_ID,".png")),width = 11250,height = 10000,units = "px",pointsize = 12,res = 7000)
krsa_histogram_plot(fin$KRSA_Table, fin$count_mtx, "BLK")
dev.off()

png(file = (paste0(EAB_directory_output_comparison, "Fig9-EphA2","-",experiment_ID,".png")),width = 11250,height = 10000,units = "px",pointsize = 12,res = 7000)
...
png(file = (paste0(EAB_directory_output_comparison, "Fig11-FGFR3","-",experiment_ID,".png")),width = 11250,height = 10000,units = "px",pointsize = 12,res = 7000)
krsa_histogram_plot(fin$KRSA_Table, fin$count_mtx, "FGFR3")
dev.off()

png(file = (paste0(EAB_directory_output_comparison, "Fig12-FGFR2","-",experiment_ID,".png")),width = 11250,height = 10000,units = "px",pointsize = 12,res = 7000)
krsa_histogram_plot(fin$KRSA_Table, fin$count_mtx, "FGFR2")
dev.off()

png(file = (paste0(EAB_directory_output_comparison, "Fig13-FGFR34","-",experiment_ID,".png")),width = 11250,height = 10000,units = "px",pointsize = 12,res = 7000)
krsa_histogram_plot(fin$KRSA_Table, fin$count_mtx, "FGFR4")
dev.off()

png(file = (paste0(EAB_directory_output_comparison, "Fig14-Ret","-",experiment_ID,".png")),width = 11250,height = 10000,units = "px",pointsize = 12,res = 7000)
krsa_histogram_plot(fin$KRSA_Table, fin$count_mtx, "Ret")
dev.off()

png(file = (paste0(EAB_directory_output_comparison, "Fig15-FRK","-",experiment_ID,".png")),width = 11250,height = 10000,units = "px",pointsize = 12,res = 7000)
krsa_histogram_plot(fin$KRSA_Table, fin$count_mtx, "FRK")
dev.off()
