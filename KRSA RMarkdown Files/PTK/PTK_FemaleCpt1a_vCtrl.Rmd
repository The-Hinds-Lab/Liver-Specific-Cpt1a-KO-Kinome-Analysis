...
author: 
-   <font size='16'>"**The Hinds Laboratory Pathways Lab Report**"
-   <br>
-   "**PTK Analysis Report**"
-   <br>
...
input_directory_MedianSigmBg <- "~/Library/CloudStorage/OneDrive-UniversityofKentucky/Uni of Kentucky/Kinome_PamGene/Nate/PTK/input_data/_Export_Median_SigmBg_220810135503.txt"

input_directory_Signal_Saturation <- "~/Library/CloudStorage/OneDrive-UniversityofKentucky/Uni of Kentucky/Kinome_PamGene/Nate/PTK/input_data/_Export_Signal_Saturation_220810135503.txt"

#experiment_ID

experiment_ID <- "Nate_FullReportPTK_FemaleCpt1a"
...
kinases_of_interest <-c("Src", "ZAP70", "Lck", "BLK", "Syk", "Yes", "Kit", "Fyn", "DDR1", "Abl", "Lyn", "InSR", "LTK", "HER3", "Arg", "HCK")
...
source("/Users/Evelyn/Library/CloudStorage/OneDrive-UniversityofKentucky/Uni of Kentucky/Kinome_PamGene/Custom_Report_Hinds/KRSA-master/R/krsa_heatmap PTK.R")
...
source("/Users/Evelyn/Library/CloudStorage/OneDrive-UniversityofKentucky/Uni of Kentucky/Kinome_PamGene/Custom_Report_Hinds/KRSA-master/R/krsa_waterfall.R")
...
png(file = (paste0(EAB_directory_output_comparison_families, "Fig1-PDGFR","-",experiment_ID,".png")),width = 11250,height = 10000,units = "px",pointsize = 12,res = 7000)
krsa_histogram_plot(fin$KRSA_Table, fin$count_mtx, "PDGFR")
dev.off()

png(file = (paste0(EAB_directory_output_comparison_families, "Fig2-SRC","-",experiment_ID,".png")),width = 11250,height = 10000,units = "px",pointsize = 12,res = 7000)
krsa_histogram_plot(fin$KRSA_Table, fin$count_mtx, "SRC")
dev.off()

png(file = (paste0(EAB_directory_output_comparison_families, "Fig3-SYK","-",experiment_ID,".png")),width = 11250,height = 10000,units = "px",pointsize = 12,res = 7000)
...
png(file = (paste0(EAB_directory_output_comparison_families, "Fig5-RET","-",experiment_ID,".png")),width = 11250,height = 10000,units = "px",pointsize = 12,res = 7000)
krsa_histogram_plot(fin$KRSA_Table, fin$count_mtx, "RET")
dev.off()

png(file = (paste0(EAB_directory_output_comparison_families, "Fig6-FAK","-",experiment_ID,".png")),width = 11250,height = 10000,units = "px",pointsize = 12,res = 7000)
krsa_histogram_plot(fin$KRSA_Table, fin$count_mtx, "FAK")
dev.off()

png(file = (paste0(EAB_directory_output_comparison_families, "Fig7-EPH","-",experiment_ID,".png")),width = 11250,height = 10000,units = "px",pointsize = 12,res = 7000)
krsa_histogram_plot(fin$KRSA_Table, fin$count_mtx, "EPH")
dev.off()

png(file = (paste0(EAB_directory_output_comparison_families, "Fig8-JAK","-",experiment_ID,".png")),width = 11250,height = 10000,units = "px",pointsize = 12,res = 7000)
krsa_histogram_plot(fin$KRSA_Table, fin$count_mtx, "JAK")
dev.off()

png(file = (paste0(EAB_directory_output_comparison_families, "Fig9-AXL","-",experiment_ID,".png")),width = 11250,height = 10000,units = "px",pointsize = 12,res = 7000)
krsa_histogram_plot(fin$KRSA_Table, fin$count_mtx, "AXL")
dev.off()

png(file = (paste0(EAB_directory_output_comparison_families, "Fig10-SEV","-",experiment_ID,".png")),width = 11250,height = 10000,units = "px",pointsize = 12,res = 7000)
krsa_histogram_plot(fin$KRSA_Table, fin$count_mtx, "SEV")
dev.off()

png(file = (paste0(EAB_directory_output_comparison_families, "Fig11-FRK","-",experiment_ID,".png")),width = 11250,height = 10000,units = "px",pointsize = 12,res = 7000)
krsa_histogram_plot(fin$KRSA_Table, fin$count_mtx, "FRK")
dev.off()

png(file = (paste0(EAB_directory_output_comparison_families, "Fig12-VEGFR","-",experiment_ID,".png")),width = 11250,height = 10000,units = "px",pointsize = 12,res = 7000)
krsa_histogram_plot(fin$KRSA_Table, fin$count_mtx, "VEGFR")
dev.off()

png(file = (paste0(EAB_directory_output_comparison_families, "Fig13-FER","-",experiment_ID,".png")),width = 11250,height = 10000,units = "px",pointsize = 12,res = 7000)
krsa_histogram_plot(fin$KRSA_Table, fin$count_mtx, "FER")
dev.off()

png(file = (paste0(EAB_directory_output_comparison_families, "Fig14-MET","-",experiment_ID,".png")),width = 11250,height = 10000,units = "px",pointsize = 12,res = 7000)
...
krsa_histogram_plot(fin$KRSA_Table, fin$count_mtx, c("Src", "ZAP70", "Lck", "BLK", "Syk", "Yes", "Kit", "Fyn", "DDR1", "Abl", "Lyn", "InSR", "LTK", "HER3", "Arg", "HCK"))

png(file = (paste0(EAB_directory_output_comparison, "Fig1-Src","-",experiment_ID,".png")),width = 11250,height = 10000,units = "px",pointsize = 12,res = 7000)
krsa_histogram_plot(fin$KRSA_Table, fin$count_mtx, "Src")
dev.off()

png(file = (paste0(EAB_directory_output_comparison, "Fig2-ZAP70","-",experiment_ID,".png")),width = 11250,height = 10000,units = "px",pointsize = 12,res = 7000)
krsa_histogram_plot(fin$KRSA_Table, fin$count_mtx, "ZAP70")
dev.off()

png(file = (paste0(EAB_directory_output_comparison, "Fig3-Lck","-",experiment_ID,".png")),width = 11250,height = 10000,units = "px",pointsize = 12,res = 7000)
...
png(file = (paste0(EAB_directory_output_comparison, "Fig5-Syk","-",experiment_ID,".png")),width = 11250,height = 10000,units = "px",pointsize = 12,res = 7000)
krsa_histogram_plot(fin$KRSA_Table, fin$count_mtx, "Syk")
dev.off()

png(file = (paste0(EAB_directory_output_comparison, "Fig6-Yes","-",experiment_ID,".png")),width = 11250,height = 10000,units = "px",pointsize = 12,res = 7000)
krsa_histogram_plot(fin$KRSA_Table, fin$count_mtx, "Yes")
dev.off()

png(file = (paste0(EAB_directory_output_comparison, "Fig7-Kit","-",experiment_ID,".png")),width = 11250,height = 10000,units = "px",pointsize = 12,res = 7000)
krsa_histogram_plot(fin$KRSA_Table, fin$count_mtx, "Kit")
dev.off()

png(file = (paste0(EAB_directory_output_comparison, "Fig8-Fyn","-",experiment_ID,".png")),width = 11250,height = 10000,units = "px",pointsize = 12,res = 7000)
krsa_histogram_plot(fin$KRSA_Table, fin$count_mtx, "Fyn")
dev.off()

png(file = (paste0(EAB_directory_output_comparison, "Fig9-DDR1","-",experiment_ID,".png")),width = 11250,height = 10000,units = "px",pointsize = 12,res = 7000)
krsa_histogram_plot(fin$KRSA_Table, fin$count_mtx, "DDR1")
dev.off()

png(file = (paste0(EAB_directory_output_comparison, "Fig10-Abl","-",experiment_ID,".png")),width = 11250,height = 10000,units = "px",pointsize = 12,res = 7000)
krsa_histogram_plot(fin$KRSA_Table, fin$count_mtx, "Abl")
dev.off()

png(file = (paste0(EAB_directory_output_comparison, "Fig11-Lyn","-",experiment_ID,".png")),width = 11250,height = 10000,units = "px",pointsize = 12,res = 7000)
krsa_histogram_plot(fin$KRSA_Table, fin$count_mtx, "Lyn")
dev.off()

png(file = (paste0(EAB_directory_output_comparison, "Fig12-InSR","-",experiment_ID,".png")),width = 11250,height = 10000,units = "px",pointsize = 12,res = 7000)
krsa_histogram_plot(fin$KRSA_Table, fin$count_mtx, "InSR")
dev.off()

png(file = (paste0(EAB_directory_output_comparison, "Fig13-LTK","-",experiment_ID,".png")),width = 11250,height = 10000,units = "px",pointsize = 12,res = 7000)
krsa_histogram_plot(fin$KRSA_Table, fin$count_mtx, "LTK")
dev.off()

png(file = (paste0(EAB_directory_output_comparison, "Fig14-HER3","-",experiment_ID,".png")),width = 11250,height = 10000,units = "px",pointsize = 12,res = 7000)
krsa_histogram_plot(fin$KRSA_Table, fin$count_mtx, "HER3")
dev.off()

png(file = (paste0(EAB_directory_output_comparison, "Fig15-Arg","-",experiment_ID,".png")),width = 11250,height = 10000,units = "px",pointsize = 12,res = 7000)
krsa_histogram_plot(fin$KRSA_Table, fin$count_mtx, "Arg")
dev.off()

png(file = (paste0(EAB_directory_output_comparison, "Fig16-HCK","-",experiment_ID,".png")),width = 11250,height = 10000,units = "px",pointsize = 12,res = 7000)
